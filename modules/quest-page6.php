...
<body>
	...
	<div class="overlay js-overlay-modal"></div>
	  ...
	  <!--Это див, в котором будет панель инструментов-->
	    ...
	    <div class="rightSide">
	    	...
	    	<div id="showGame">
						...
						<div id="line" style="position: absolute; left:25px; top:35px; width:555px; height: 100%; background: url('images/bg/level6-lile.png') no-repeat center / contain;"></div>

	    	    <div id="herro" style="margin: -35px 0 0 -17px"></div>
	  ...
	  <xml id="toolbox" style="display: none">
	    ...
	    <block type="left_2"></block>

	    <block type="right_3"></block>   
	    </category>
	  </xml>
