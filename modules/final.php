...
<body>
	...
	<div id="score" style="display:none"><?php echo $results->points ?></div>
	  ...
	  <div class="modal modal-final" id="modal-final" data-modal="3">
	    <div class="content">
	    	<p><strong>Сервермэн:</strong> - Теперь сервер исправен, и мы можем ввести собранные части кода, чтобы победить БАГа! <br> У меня есть недостающая часть кода <strong>«З».</strong></p><p><strong>Айтигеник:</strong> - Пока мы были в пещере, я обнаружил часть <strong>«ПЕ»</strong> - это последняя часть! Теперь нам осталось лишь правильно их собрать и ввести полученное слово, чтобы наконец победить БАГа!</p>
	    	<div class="word"></div>
